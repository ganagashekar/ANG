...
@Component({
  selector: 'app-controllerEditTemplate',
  templateUrl: './controllerEditTemplate.component.html',
  styleUrls: ['./controllerEditTemplate.component.scss']
})
export class ControllerEditTemplateComponent implements OnInit {
  @Output()
 ...
 // SelectedvendorsiteId: bigint;
  ...
  constructor(public dialogRef: MatDialogRef<ControllerEditTemplateComponent>, private _controllerservices: ControllerService,
