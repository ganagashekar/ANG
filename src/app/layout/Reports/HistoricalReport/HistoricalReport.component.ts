...
@Component({
  selector: 'app-HistoricalReport',
  templateUrl: './HistoricalReport.component.html',
  styleUrls: ['./HistoricalReport.component.css']
})
export class HistoricalReportComponent implements OnInit , AfterViewInit {
